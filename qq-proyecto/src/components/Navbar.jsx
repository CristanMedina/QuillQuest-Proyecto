          ...
          <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto shadow-xl  bg-[#6d809aff]">
                    <ul class="space-y-2 font-medium">
                      ...
                      <li>
                            <Link href="/auth/ingreso" className='group flex items-center uppercase text-xl rounded-xl p-4 text-[#d7e2e9ff] hover:bg-[#d7e2e9ff] hover:text-[#264946ff] transition duration-300'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                      ...
                      <li>
                            <Link href="\auth\registro" className='group flex items-center uppercase text-xl rounded-xl p-4 text-[#d7e2e9ff] hover:bg-[#d7e2e9ff] hover:text-[#264946ff] transition duration-300'> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
